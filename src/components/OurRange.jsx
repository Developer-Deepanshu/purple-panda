    ...
    <>
      <section className="py-5">
        <div className="container">
          <div className="ourRangeBG py-5 px-5 border_radius10">
            <h2 className="text-white fw-bold fs_xl4 text-center mb-0 py-5">
              Our <span className="text_purpleGrident">Range</span>
            </h2>
            <p className="fw-normal text-white ff_Montserrat fs_md text-center mt-4">
            ...
            <p className="fw-normal text-white ff_Montserrat fs_md text-center mb-0 pb-5 pt-3">
